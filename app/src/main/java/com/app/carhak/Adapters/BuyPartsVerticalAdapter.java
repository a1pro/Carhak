...
public class BuyPartsVerticalAdapter extends RecyclerView.Adapter<BuyPartsVerticalAdapter.ViewHolder> {
    Context context;
    List<PartsData> list;
    public BuyPartsVerticalAdapter(Context context, List<PartsData> list) {
        this.list=list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.buyvechile_vertical_items, parent, false);
        return new BuyPartsVerticalAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        if (list.get(position).getTitle()!=null){
            holder.tv_partname.setText(list.get(position).getTitle());
        }
        ...
        if (list.get(position).getImages()!=null){
            ...
            Glide.with(context).load(ApiUtils.IMAGE_PARTS_BASE_URL+namesList[0]).diskCacheStrategy(DiskCacheStrategy.ALL).into(holder.img_parts);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private CircleImageView img_parts;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            img_parts=itemView.findViewById(R.id.img_parts);
            rating=itemView.findViewById(R.id.rating);
            bt_detail=itemView.findViewById(R.id.bt_detail);
            tv_partname=itemView.findViewById(R.id.tv_partname);
        }
    }
}
